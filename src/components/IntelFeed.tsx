    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="gotham-tag gotham-tag--info" style={{ fontSize:'11px', padding: '1px 5px' }}>{news.length}</span>
                ...
                news.slice(0, 25).map((item: any, i: number) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      <span className={`text-[12px] font-mono font-bold tracking-widest ${getRiskClass(item.risk_score)}`}>
                    ...
                    {item.machine_assessment && (
                      <div className="mt-1.5 flex items-start gap-1.5 bg-red-950/20 border border-red-900/20 rounded px-2 py-1">
                        ...
                        <span className="text-[12px] font-mono text-red-400/80 leading-relaxed">
                          {item.machine_assessment}
                        </span>
                      </div>
                    )}
