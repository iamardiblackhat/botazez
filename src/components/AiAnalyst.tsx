...
function renderMarkdown(text: string): string {
  ...
  return escaped
    ...
    .replace(/^- (.+)/gm, '<div class="flex items-start gap-1.5 ml-1 my-0.5"><span class="text-[var(--gold-dim)] mt-[3px] text-[11px]">◆</span><span>$1</span></div>')
    .replace(/\n/g, '<br />');
}
              ...
              >
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="flex flex-col">
                    <span className="hud-text text-[11px] text-[var(--text-heading)]">BOTAZEZ ANALYST</span>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        ...
                        {apiKeyInput.trim() && (
                          <>
                            <button
                              onClick={saveApiKey}
                              className="px-3 rounded-lg text-[12px] font-mono tracking-wider transition-all"
                              style={{
                            ...
                            <button
                              onClick={clearApiKey}
                              className="px-2 rounded-lg text-[12px] font-mono tracking-wider transition-all hover:bg-red-500/10"
                              style={{
                      ...
                      <p className="text-[11px] font-mono text-[var(--text-muted)] leading-relaxed">
                        Your key is stored locally and sent only to the BOTAZEZ server. Get a free key at{' '}
                        <a
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1.5 mb-1.5">
                        ...
                        >
                          {msg.role === 'user' ? 'OPERATOR' : 'BOTAZEZ ANALYST'}
                        </span>
                ...
                {isLoading && (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1">
                        <span className="text-[12px] font-mono tracking-[0.15em] text-[var(--gold-primary)] uppercase">
              ...
              >
                ...
                <div className="flex gap-2 mb-2">
                  <button
                    ...
                    disabled={isLoading}
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12px] font-mono tracking-[0.1em] uppercase transition-all disabled:opacity-40"
                    style={{
