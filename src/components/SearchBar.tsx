  ...
  if (!open && !alwaysExpanded) {
    return (
      <button
        ...
        className="flex items-center gap-1.5 glass-panel-sm px-3 py-2 text-[12px] font-mono tracking-[0.15em] text-[var(--text-muted)] hover:text-[var(--gold-primary)] hover:border-[var(--border-active)] transition-all hover:shadow-[0_0_12px_rgba(212,175,55,0.08)]"
      >
  ...
  return (
    <div className="relative w-full" ref={containerRef}>
      ...
      >
        ...
        <span className="text-[11px] text-[var(--text-muted)] font-mono opacity-50 hidden md:inline">CTRL+F</span>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {secondary && (
                    <div className="text-[11px] text-[var(--text-muted)] font-mono truncate mt-0.5">{secondary}</div>
                  )}
                </div>
