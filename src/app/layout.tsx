...
const SITE_URL = "https://botazez.com";
const SITE_NAME = "BOTAZEZ";
const SITE_TITLE = "BOTAZEZ — Open Source Intelligence Platform | Live Flight Tracking, CCTV, OSINT Tools & More";
...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_TITLE,
    template: "%s | BOTAZEZ Intelligence",
  },
  ...
  keywords: [
    ...
    // Brand
    "botazez", "botazez", "botazez.com",
  ],
  authors: [{ name: "Botazez Project", url: SITE_URL }],
  creator: "Botazez Project",
  publisher: "Botazez Project",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "BOTAZEZ — The Open-Source Palantir Alternative | Live Flights, CCTV, Satellites & OSINT Tools",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BOTAZEZ — Open Source Intelligence Platform with Live Tracking & OSINT Tools",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "🛰️ BOTAZEZ — Open Source Palantir Alternative | Live Tracking + OSINT Tools",
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "BOTAZEZ",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "BOTAZEZ — OSINT Toolkit & Intelligence Platform",
  alternateName: ["BOTAZEZ", "BotazezAI", "Botazez OSINT"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
  ...
  sameAs: ["https://www.instagram.com/ardi.blackhat"],
  author: {
    "@type": "Organization",
    name: "Botazez Project",
    url: SITE_URL,
  },
};
